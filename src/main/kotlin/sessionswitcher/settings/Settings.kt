...
class Settings(val provider: SettingsProvider) {
    ...
    val filterSessionMode = EnumSetting(
        provider,
    ...
    val editorDoNotAskOverwriteConfirmation = BooleanSetting(
        provider,
    ...
    val cookiesUpdateMode = EnumSetting(
        provider,
    ...
    val headersUpdateMode = EnumSetting(
        provider,
    ...
    val cookiesInjectMode = EnumSetting(
        provider,
    ...
    val injectorHighlightColor = EnumSetting(
        provider,
