...
abstract class SettingsItem<T>(
    ...
    abstract fun getImpl(
        key: String,
        store: Store,
    ): T?

    abstract fun setImpl(
        key: String,
        value: T,
        store: Store,
    )
...
class BooleanSetting(
    ...
    override fun getImpl(
        key: String,
        store: Store,
    ): Boolean? = this.provider.getBoolean(key, store)

    override fun setImpl(
        key: String,
        value: Boolean,
        store: Store,
    ) = this.provider.setBoolean(key, value, store)
...
class IntSetting(
    ...
    override fun getImpl(
        key: String,
        store: Store,
    ): Int? = this.provider.getInt(key, store)
...
class StringSetting(
    ...
    override fun getImpl(
        key: String,
        store: Store,
    ): String? = this.provider.getString(key, store)
